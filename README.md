...
Update your database credentials inside application.properties (if applicable) or directly in DatabaseConnection.java.
...
System generates a unique QR code (encoded with session and time data).

Students scan the code via their dashboard.

The app validates and stores attendance in the database.
